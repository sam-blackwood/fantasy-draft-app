-- Seed script for players table
-- Run with: psql postgres://localhost:5432/fantasy_draft_dev?sslmode=disable -f scripts/seed_players.sql

-- Clear existing player data (cascades to event_players and draft_results)
TRUNCATE TABLE players CASCADE;

-- Insert all players from The Players Championship 2026 field
